...
export const DeleteAccountTab = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Danger Zone Header */}
      <div>
        <div className="flex items-center space-x-2 text-rose-700 dark:text-rose-400 font-bold text-xs uppercase tracking-wider mb-1">
      ...
      {/* Warning Box */}
      <div className="p-6 rounded-2xl bg-rose-50/80 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/60">
        <div className="flex items-start space-x-3">
          <AlertTriangle className="w-5 h-5 text-rose-600 dark:text-rose-400 mt-0.5 shrink-0" />
          <div>
            <h4 className="font-semibold text-rose-900 dark:text-rose-200 text-sm mb-1">
              Please take a moment to review what happens when you delete your account:
            </h4>
            <ul className="text-xs text-rose-800/90 dark:text-rose-300/90 space-y-1.5 list-disc list-inside mt-2">
      ...
      <div className="p-6 rounded-2xl bg-white dark:bg-[#1A2634] border border-[#EAE4D9] dark:border-[#2A3848] shadow-xs space-y-6">
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2.5 bg-slate-50 dark:bg-[#16202B] border border-slate-300 dark:border-[#2A3848] rounded-xl text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500"
          >
        ...
        {reason === 'other' && (
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-slate-50 dark:bg-[#16202B] border border-slate-300 dark:border-[#2A3848] rounded-xl text-sm text-slate-800 dark:text-slate-200"
            />
          </div>
        )}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-[#16202B] border border-slate-300 dark:border-[#2A3848] rounded-xl text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-rose-400"
            />
          </div>
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 animate-in fade-in duration-150">
          <div className="bg-white dark:bg-[#16202B] max-w-md w-full rounded-2xl p-6 shadow-2xl border border-rose-200 dark:border-rose-900/60">
            <div className="w-12 h-12 rounded-full bg-rose-100 dark:bg-rose-950/60 flex items-center justify-center text-rose-600 dark:text-rose-400 mb-4 mx-auto">
              <AlertTriangle className="w-6 h-6" />
            </div>

            <h4 className="font-serif-editorial text-xl font-bold text-center text-slate-900 dark:text-white mb-2">
            ...
            <div className="flex space-x-3">
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-4 py-2.5 rounded-xl border border-slate-300 dark:border-[#2A3848] text-slate-700 dark:text-slate-300 font-medium text-sm hover:bg-slate-50 dark:hover:bg-[#1E293B] transition-colors"
              >
                Cancel
              </button>
              <button
